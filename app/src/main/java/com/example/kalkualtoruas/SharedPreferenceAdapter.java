...
public class SharedPreferenceAdapter extends RecyclerView.Adapter<SharedPreferenceAdapter.ExampleViewHolder> {
    private final ArrayList<Datalist> mExampleList;
    ...
    public SharedPreferenceAdapter(ArrayList<Datalist> exampleList) {
    ...
    public void onBindViewHolder(ExampleViewHolder holder, int position) {
        Datalist currentItem = mExampleList.get(position);
