...
public class MainActivity extends AppCompatActivity {
    ArrayList<Datalist> mExampleList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kurangData = findViewById(R.id.kurangData);
        kaliData = findViewById(R.id.kaliData);
        dataBagi = findViewById(R.id.dataBagi);
    ...
    private void setInsertButton() {
        Button buttonInsert = findViewById(R.id.button_tambah);
    ...
    private void insertItem(String line1, String line2) {
        ...
        mExampleList.add(new Datalist(line1, operasi, line2, String.valueOf(hasil)));
